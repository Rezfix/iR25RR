...
client.on('message', message => {
    ...
    .setAuthor("[ Nexta Bot ]", " https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455")
    .addField("**[ Nexta Prefix] :**","**[ + ]**" , true)
    .addField("** [ Nexta ID ] **", "**"+"459725014237970492"+"**",true)
    .addField("** [ Nexta ] **","** دراجون**")
    ...
    .setColor("ffffff")
    .setFooter(`+help to see all Nexta commands `, ' https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455')
    message.channel.sendEmbed(embed)
    }
    });

client.on("guildDelete", guild => {
    console.log(` Nexta Left From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  Nexta™ `)
                .setTitle(" Nexta Left Server !")
                .addField("**Guild Name:**", guild.name )
                 .addField("**Owner:**", guild.owner.user.username )
                 .addField("**Owner id:**", guild.owner.user.id )
                 .addField("**MEMBER COUNT:**", g )
                  .setThumbnail (i)
client.channels.get("530791844007772160").send({ embed: embed });
});


client.on("guildCreate", guild => {
console.log(` Nexta Added From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  Nexta `)
                .setTitle(" Nexta Added To Server !")
                .addField("**Guild Name:**", guild.name )
                 .addField("**Owner:**", guild.owner.user.username )
                 .addField("**MEMBER COUNT:**", g )
                  .setThumbnail (i)
